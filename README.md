...
Highly skilled in creating interface design, supported by a strong visual foundation, enabling productive collaboration with designers to optimize user journeys and accessibility. Passionate about crafting usable components and interfaces, employing micro-interactions and accessibility best practices to craft seamless experiences. Dedicated to code quality, endorsing good practices, including code reviews, knowledge sharing, and unit testing to ensure codebases remain robust, maintainable, and efficient over time.
